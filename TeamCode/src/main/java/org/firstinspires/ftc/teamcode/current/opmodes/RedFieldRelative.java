...
@TeleOp()
public class RedFieldRelative extends CommandOpMode {
    ...
    public void initialize() {
        ...
        m_mecanumDrive = new MecanumDrive(hardwareMap, configs, new Pose2d(42.38, 161, Rotation2d.fromDegrees(270)), MecanumDrive.Alliance.RED);
